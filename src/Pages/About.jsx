...
// Memoized Components
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-4 px-4 xs:px-5 sm:px-6">
    <div className="inline-block relative group">
      <h2
        className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]"
        data-aos="zoom-in-up"
    ...
    <p
      className="mt-3 text-gray-400 max-w-2xl mx-auto text-sm xs:text-base sm:text-lg flex flex-col xs:flex-row items-center justify-center gap-2"
      data-aos="zoom-in-up"
      data-aos-duration="800"
    >
      <Sparkles className="w-4 h-4 xs:w-5 xs:h-5 text-purple-400" />
      <span className="text-center">Transforming ideas into digital experiences</span>
      <Sparkles className="w-4 h-4 xs:w-5 xs:h-5 text-purple-400" />
    </p>
  </div>
));
...
const ProfileImage = memo(() => (
  <div className="flex justify-center items-center p-4 sm:p-8 lg:p-12 lg:py-0 lg:pb-0">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      {/* Optimized gradient backgrounds with reduced complexity for mobile */}
      <div className="absolute -inset-4 sm:-inset-6 opacity-[20%] sm:opacity-[25%] z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-violet-600 via-indigo-500 to-purple-600 rounded-full blur-xl sm:blur-2xl animate-spin-slower" />
        <div className="absolute inset-0 bg-gradient-to-l from-fuchsia-500 via-rose-500 to-pink-600 rounded-full blur-xl sm:blur-2xl animate-pulse-slow opacity-50 hidden sm:block" />
        <div className="absolute inset-0 bg-gradient-to-t from-blue-600 via-cyan-500 to-teal-400 rounded-full blur-xl sm:blur-2xl animate-float opacity-50 hidden sm:block" />
      </div>
      <div className="relative">
        <div className="w-48 h-48 xs:w-56 xs:h-56 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden shadow-[0_0_20px_rgba(120,119,198,0.3)] sm:shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          <div className="absolute inset-0 border-2 sm:border-4 border-white/20 rounded-full z-20 transition-all duration-700 group-hover:border-white/40 group-hover:scale-105" />
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-700 z-20 hidden sm:block">
            ...
            <div className="absolute inset-0 rounded-full border-4 sm:border-8 border-white/10 scale-0 group-hover:scale-100 transition-transform duration-700 animate-pulse-slow" />
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="space-y-6" data-aos="fade-up" data-aos-duration="1000">
    <div className="space-y-4">
      ...
      <div className="prose prose-lg text-gray-300 leading-relaxed space-y-4">
        ...
        <p>
          With <span className="text-blue-400 font-semibold">4 years of hands-on experience</span>, I specialize in building 
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white" id="About">
      <div className="px-4 xs:px-5 sm:px-6 md:px-8 lg:px-[8%] xl:px-[10%] pt-16 xs:pt-20 sm:pt-24 md:pt-28 lg:pt-[100px] pb-12 sm:pb-16 md:pb-20 lg:pb-[80px]">
        <Header />
        
        {/* Main About Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          <AboutDescription />
          <ProfileImage />
        </div>
        ...
        <div className="mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 
              className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7] mb-3 sm:mb-4"
              data-aos="fade-up"
              data-aos-duration="800"
            >
              Technical Expertise
            ...
            <p 
              className="text-gray-400 max-w-2xl mx-auto text-sm xs:text-base sm:text-lg px-2"
              data-aos="fade-up"
              data-aos-duration="1000"
            >
        ...
        {/* Stats Section */}
        <a href="#Portofolio">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 cursor-pointer">
            {statsData.map((stat) => (
