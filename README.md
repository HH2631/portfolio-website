# Portfolio V5  
Hello everyone!  
Let me introduce myself, I'm Hamzeh Hijazi. On this occasion, I'd like to share the portfolio website project that I've developed.  
...
1. **Download this project:**  
   ...
   ```bash  
   git clone https://github.com/hamzehhijazi/Portfolio_V5.git  
   ```  
